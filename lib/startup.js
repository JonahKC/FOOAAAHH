...
function preload() {
  ...
  console.log(`Fonts loaded in ${performance.now()-time} milliseconds`);
  ...
  console.log(`Images loaded in ${performance.now()-time} milliseconds`);
  ...
  soundtracks = [loadSound("../audio/soundtrack1.mp3")];
  soundtracks.forEach(s => {
    s.playMode('restart');
    s.loop = true;
  });
  console.log(`Sounds loaded in ${performance.now()-time} milliseconds`);
