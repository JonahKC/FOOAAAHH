...
console.log(`Loaded constants in ${performance.now()-time} milliseconds`);
...
//let left_control;
//let right_control;
//let left_control_image;
//let right_control_image;
//let move = 0;
...
console.log(`Loaded variables in ${performance.now()-time} milliseconds`)